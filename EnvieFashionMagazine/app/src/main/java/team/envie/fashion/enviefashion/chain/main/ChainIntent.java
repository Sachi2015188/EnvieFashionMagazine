 ...
 */
public class ChainIntent<T extends ChainIntent<T>> implements team.envie.fashion.enviefashion.chain.core.ChainIntentInterface<ChainIntent<T>> {
    ...
    public ChainIntent<T> actionViewVideo(File file) {
        ...
        if (file.exists()) {
            ...
            team.envie.fashion.enviefashion.utils.Logged.d("--" + "file not exist" + "--");
        }
        return self;
    }
